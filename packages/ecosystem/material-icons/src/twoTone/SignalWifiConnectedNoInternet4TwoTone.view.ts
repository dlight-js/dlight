...
class SignalWifiConnectedNoInternet4TwoTone extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SignalWifiConnectedNoInternet4TwoTone as Pretty as Typed<DLightIconType, HTMLSpanElement>
