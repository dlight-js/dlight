...
class Icon3dRotationTwoTone extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
      ...
      .name("Icon3dRotationTwoTone")
  }
}

export default Icon3dRotationTwoTone as Pretty as Typed<DLightIconType, HTMLSpanElement>
