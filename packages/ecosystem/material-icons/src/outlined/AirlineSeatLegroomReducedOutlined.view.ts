...
class AirlineSeatLegroomReducedOutlined extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default AirlineSeatLegroomReducedOutlined as Pretty as Typed<DLightIconType, HTMLSpanElement>
