...
class SignalWifiConnectedNoInternet4Outlined extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SignalWifiConnectedNoInternet4Outlined as Pretty as Typed<DLightIconType, HTMLSpanElement>
