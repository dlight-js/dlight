...
class SystemSecurityUpdateWarningOutlined extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SystemSecurityUpdateWarningOutlined as Pretty as Typed<DLightIconType, HTMLSpanElement>
