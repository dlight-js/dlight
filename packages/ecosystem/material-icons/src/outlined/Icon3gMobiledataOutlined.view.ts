...
class Icon3gMobiledataOutlined extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
      ...
      .name("Icon3gMobiledataOutlined")
  }
}

export default Icon3gMobiledataOutlined as Pretty as Typed<DLightIconType, HTMLSpanElement>
