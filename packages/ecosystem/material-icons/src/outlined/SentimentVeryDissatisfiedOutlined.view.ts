...
class SentimentVeryDissatisfiedOutlined extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SentimentVeryDissatisfiedOutlined as Pretty as Typed<DLightIconType, HTMLSpanElement>
