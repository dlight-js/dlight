...
class Icon4gPlusMobiledataOutlined extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
      ...
      .name("Icon4gPlusMobiledataOutlined")
  }
}

export default Icon4gPlusMobiledataOutlined as Pretty as Typed<DLightIconType, HTMLSpanElement>
