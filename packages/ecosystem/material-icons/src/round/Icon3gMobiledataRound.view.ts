...
class Icon3gMobiledataRound extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
      ...
      .name("Icon3gMobiledataRound")
  }
}

export default Icon3gMobiledataRound as Pretty as Typed<DLightIconType, HTMLSpanElement>
