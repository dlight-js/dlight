...
class SignalWifiConnectedNoInternet4Round extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SignalWifiConnectedNoInternet4Round as Pretty as Typed<DLightIconType, HTMLSpanElement>
