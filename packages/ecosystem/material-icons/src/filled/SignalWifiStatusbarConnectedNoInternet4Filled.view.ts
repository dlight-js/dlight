...
@View
@ForwardProp
class SignalWifiStatusbarConnectedNoInternet4Filled {
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SignalWifiStatusbarConnectedNoInternet4Filled as Pretty as Typed<DLightIconType, HTMLSpanElement>
