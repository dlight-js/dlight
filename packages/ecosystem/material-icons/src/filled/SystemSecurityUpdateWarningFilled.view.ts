...
class SystemSecurityUpdateWarningFilled extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SystemSecurityUpdateWarningFilled as Pretty as Typed<DLightIconType, HTMLSpanElement>
