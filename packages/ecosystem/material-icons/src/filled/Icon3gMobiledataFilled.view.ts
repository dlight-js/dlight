...
class Icon3gMobiledataFilled extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
      ...
      .name("Icon3gMobiledataFilled")
  }
}

export default Icon3gMobiledataFilled as Pretty as Typed<DLightIconType, HTMLSpanElement>
