...
class SignalWifiStatusbarConnectedNoInternet4Sharp extends View {
  _$forwardProps = true
  Body() {
    DLightIcon()
      .forwardProps(true)
...
export default SignalWifiStatusbarConnectedNoInternet4Sharp as any as Typed<DLightIconType>
